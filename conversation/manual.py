            ...
            async with client.live.connect() as connection:
                await connection.session.start(
                    session={
                        "model": "gpt-live-1",
                        "instructions": (
                            "Questa è una prova di conversazione audio in italiano. "
                            "Parla in modo naturale, caldo e conciso. "
                            ...
                            "Non hai strumenti, memoria personale o controllo "
                            "del robot in questa prova. Non promettere azioni "
                            "e non delegare compiti: limita la prova al dialogo."
                        ),
                        "audio": {
                ...
                try:
                    ...
                    print(
                        ...
                        "Parla pure. Durata massima: 120 secondi. Ctrl+C per uscire.",
                        flush=True,
                    )
                    ...
                    try:
                        ...
                        print("\nFine dei due minuti di prova.", flush=True)
                finally:
